...
export const MINTECH_MODULES: MinTechModule[] = [
  {
    ...
    mainInterface: "Telegram bot intake + dashboard evidence report",
    href: "/bags",
    accent: "bg-red-600",
  },
  {
    ...
    mainInterface: "Telegram bot intake + owner oversight dashboard",
    href: "/purchases",
    accent: "bg-amber-600",
  },
  {
    ...
    mainInterface: "Telegram WHT/payment intake + accountant report + SMS gateway",
    href: "/receivables",
    accent: "bg-sky-700",
  },
  {
    ...
    mainInterface: "Telegram bot intake + LLM receipt reading + dashboard report",
    href: "/receipts",
  ...
  },
  {
    ...
    mainInterface: "Telegram gate intake + AI stone scoring + dashboard traceability",
    href: "/gate",
    accent: "bg-stone-700",
  },
];
